...
export const Appointments: React.FC<AppointmentsProps> = ({ isDark, toggleTheme, onBack, onLogoClick, onLogout, onProfileClick }) => {
  ...
  const doctors = [
    {
      ...
      fee: '$80',
      available: true,
      image: 'https://images.unsplash.com/photo-1615177393114-bd2917a4f74a?w=300'
    },
    {
      id: 2,
          ...
          <div>
            <Card className="rounded-3xl shadow-lg border-border mb-6">
              <CardHeader>
                ...
                <p className="text-muted-foreground">Showing doctors within 5km</p>
              </CardHeader>
                ...
                <div className="flex items-start gap-4 p-4 rounded-2xl bg-secondary/50">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-2 mt-2">
                      <Badge className="rounded-full">{selectedDoctor.fee}</Badge>
