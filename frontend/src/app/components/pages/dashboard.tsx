...
import { Mic, Send, Calendar, FileText, ShoppingBag, Bell, Activity, MapPin, Star } from 'lucide-react';
...
export const Dashboard: React.FC<DashboardProps> = ({ isDark, toggleTheme, onNavigate, onLogoClick, onLogout, onProfileClick }) => {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2">
            <Card className="rounded-3xl shadow-lg border-border h-[calc(100vh-200px)]">
